...
from spectral_l import exact, Sequentialmodel, training_data_lhb
...
#print("PINN.parameters()",list(PINN.parameters()))
optimizer = torch.optim.Adam(PINN.parameters(), lr = 0.0001)

start = timer()
PINN.train_model_adam(optimizer, x_boundary, u_boundary, x_train, 3e4)
end = timer()
